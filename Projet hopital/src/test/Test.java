...
public class Test {
	...
	private static void ajouterPatient() {
		...
		if(p==null) 
		{
			System.out.println("Le patient n'a jamais �t� enregistr�");
	...
	public static void afficherFileAttente() 
	{
		...
		{
			System.out.println("Aucun patient � la file d'attente");
		}
	...
	{
		// se d�connecter -> appeler la menu seConnecter
		ecrireObjet();
	...
	{	
		if(fileAttente.isEmpty()) 
		{
			System.out.println("La liste est vide, aucun patient � recevoir");
			menuMedecin();
		}	
	...
	public static void main(String[] args) {
		...
		// Menu se connecter (qui d�termine si m�decin / secr�taire)


		// une fois connecter:
		// si medecin emm�ne vers menu m�decin
		// si secr�taire emm�ne vers menu secr�taire
		...
		// Menu secr�taire
		// creerPatient
		// ajouter � la file d'attente le patient
		// afficher la file d'attente
		// Partie en pause (se d�connecter)
